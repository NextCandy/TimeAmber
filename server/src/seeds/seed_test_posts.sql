...
', '本文从架构、缓存、Hono 路由和上线检查清单出发，介绍如何构建现代 Edge API，并补齐标题、摘要、层级、链接和封面等 SEO 要素。', 1, 342, 1, strftime('%s', 'now'), 'from-cyan-500/20 to-blue-600/20', 'https://i.see.you/2026/04/28/3ctU/ChatGPT-Image-2026428-08_56_28.png'),
